...
#define FF_RTP_FLAG_RTCP_FROM_PACKET 32
...
#define FF_RTP_FLAG_OPTS(ctx, fieldname) \
    ...
    { "rtcp_from_packet", "Use the current packet timestamp in RTCP sender reports", 0, AV_OPT_TYPE_CONST, {.i64 = FF_RTP_FLAG_RTCP_FROM_PACKET}, INT_MIN, INT_MAX, AV_OPT_FLAG_ENCODING_PARAM, .unit = "rtpflags" } \
